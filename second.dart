                                            ...
                                            Align(
                                              ...
                                              child: Padding(
                                                ...
                                                child: Text(data[index].name.toString(),
                                                  style: TextStyle(fontSize: 17,fontWeight: FontWeight.w600,letterSpacing: 1),),
                                              ),
                                            ),
                                            Align(
                                                alignment:Alignment.topLeft,
                                                child: Padding(
                                                  ...
                                                  child: Text(data[index].meaning.toString(),
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          GestureDetector(onTap: (){
                                            launchwhatsapp(number: "8650982761", message: "Hello");
                                            var msg = data[index].name.toString()+"  "+ data[index].meaning.toString();
                                          ...
                                          SizedBox(height: 10),
                                          GestureDetector(onTap: (){
                                            Clipboard.setData(ClipboardData(text: data[index].name.toString()));
                                          },
